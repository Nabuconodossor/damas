...
def realizar_movimiento(tablero, fila_actual, columna_actual, fila_destino, columna_destino):
...
# Función para solicitar coordenadas al usuario
def solicitar_coordenadas():
    ...
    return fila_actual, columna_actual, fila_destino, columna_destino
...
fila_actual, columna_actual, fila_destino, columna_destino = solicitar_coordenadas()

realizar_movimiento(tablero, fila_actual, columna_actual, fila_destino, columna_destino)
